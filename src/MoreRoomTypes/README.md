...
Many thanks to pether.pg for releasing [Rooms Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=2348079481) under the MIT License, which made this project possible. More Room Types is also MIT: you are welcome to use, modify, and redistribute it under the same terms, including the original copyright notice.
...
非常感谢 pether.pg 以 MIT 协议开源 [Rooms Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=2348079481)，本模组才得以制作。更多房间同样采用 MIT：欢迎按相同条款使用、修改和再分发，并请保留原版权声明。
