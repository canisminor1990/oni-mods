...
public class FertilityMonitor : GameStateMachine<FertilityMonitor, FertilityMonitor.Instance, IStateMachineTarget, FertilityMonitor.Def>
{
	...
	public new class Instance : GameInstance
	{
			...
			: base(master, def)
		{
			...
			master.gameObject.GetComponent<KPrefabID>().SetTag(GameTags.Creatures.Expecting, set: true);
	...
	{
		if (smi.PrefabId.HasTag(GameTags.Creatures.PausedReproduction))
		{
			return false;
		}
		if (smi.PrefabId.HasTag(GameTags.Creatures.Confined))
		{
			return false;
		}
		if (!smi.PrefabId.HasTag(GameTags.Creatures.Expecting))
		{
			return false;
		}
		return true;
