...
public static class InventoryOrganization
{
	...
	{
		AddSubcategory("BUILDING_CEILING_LIGHT", Def.GetUISprite("CeilingLight").first, 100, new string[11]
		{
		...
		AddSubcategory("BUILDINGS_BED_LUXURY", Def.GetUISprite("LuxuryBed").first, 300, new string[15]
		{
		...
		AddSubcategory("BUILDING_WALLPAPER_BASIC", Assets.GetSprite("icon_inventory_solid_wallpapers"), 500, new string[14]
		{
		...
		AddSubcategory("BUILDING_WALLPAPER_FANCY", Assets.GetSprite("icon_inventory_geometric_wallpapers"), 600, new string[77]
		{
		...
		AddSubcategory("BUILDING_WALLPAPER_PRINTS", Assets.GetSprite("icon_inventory_patterned_wallpapers"), 700, new string[81]
		{
		...
		AddSubcategory("BUILDINGS_RECREATION", Def.GetUISprite("WaterCooler").first, 700, new string[27]
		{
		...
		AddSubcategory("BUILDINGS_PRINTING_POD", Def.GetUISprite("Headquarters").first, 750, new string[10] { "permit_headquarters_ceres", "permit_porta_pod_y_ice", "permit_hqbase_cyberpunk", "permit_porta_pod_y_cyberpunk", "permit_hqbase_dino", "permit_porta_pod_y_dino", "permit_hqbase_neutronium", "permit_porta_pod_y_neutronium", "permit_hqbase_aquatic", "permit_porta_pod_y_aquatic" });
		AddSubcategory("BUILDINGS_STORAGE", Def.GetUISprite("StorageLocker").first, 800, new string[35]
		{
		...
		AddSubcategory("BUILDINGS_RANCHING", Def.GetUISprite("RanchStation").first, 800, new string[4] { "permit_rancherstation_cottage", "permit_rancherstation_dino", "permit_rancherstation_neutronium", "permit_underwater_critter_condo_aquatic" });
		...
		AddSubcategory("BUILDINGS_ELECTIC_WIRES", Def.GetUISprite("Wire").first, 800, new string[15]
		{
		...
		AddSubcategory("JOY_BALLOON", Db.Get().Permits.BalloonArtistFacades[0].GetPermitPresentationInfo().sprite, 100, new string[24]
		{
		...
		AddSubcategory("BUILDING_CANVAS_STANDARD", Def.GetUISprite("Canvas").first, 100, new string[21]
		{
		...
		AddSubcategory("BUILDING_CANVAS_PORTRAIT", Def.GetUISprite("CanvasTall").first, 200, new string[16]
		{
		...
		AddSubcategory("BUILDING_CANVAS_LANDSCAPE", Def.GetUISprite("CanvasWide").first, 300, new string[17]
		{
		...
		AddSubcategory("BUILDING_SCULPTURE", Def.GetUISprite("Sculpture").first, 400, new string[54]
		{
		...
		AddSubcategory("MONUMENT_BOTTOM", Def.GetUISprite("MonumentBottom").first, 700, new string[28]
		{
		...
		AddSubcategory("MONUMENT_MIDDLE", Def.GetUISprite("MonumentMiddle").first, 600, new string[23]
		{
		...
		AddSubcategory("MONUMENT_TOP", Def.GetUISprite("MonumentTop").first, 500, new string[36]
		{
		...
		AddSubcategory("CLOTHING_TOPS_BASIC", Assets.GetSprite("icon_inventory_basic_shirts"), 100, new string[21]
		{
		...
		AddSubcategory("CLOTHING_TOPS_FANCY", Assets.GetSprite("icon_inventory_specialty_tops"), 500, new string[35]
		{
		...
		AddSubcategory("CLOTHING_TOPS_DRESS", Assets.GetSprite("icon_inventory_dress_fancy"), 500, new string[15]
		{
		...
		AddSubcategory("CLOTHING_BOTTOMS_FANCY", Assets.GetSprite("icon_inventory_fancy_pants"), 200, new string[18]
		{
		...
		AddSubcategory("CLOTHING_GLOVES_BASIC", Assets.GetSprite("icon_inventory_basic_gloves"), 100, new string[22]
		{
		...
		AddSubcategory("CLOTHING_GLOVES_FORMAL", Assets.GetSprite("icon_inventory_fancy_gloves"), 200, new string[49]
		{
		...
		AddSubcategory("CLOTHING_GLOVES_PRINTS", Assets.GetSprite("icon_inventory_specialty_gloves"), 400, new string[20]
		{
		...
		AddSubcategory("CLOTHING_SHOES_BASIC", Assets.GetSprite("icon_inventory_basic_shoes"), 100, new string[19]
		{
		...
		AddSubcategory("CLOTHING_SHOES_FANCY", Assets.GetSprite("icon_inventory_fancy_shoes"), 200, new string[20]
		{
		...
		AddSubcategory("ATMOSUIT_BODIES_BASIC", Assets.GetSprite("icon_inventory_atmosuit_body"), 200, new string[25]
		{
		...
		AddSubcategory("ATMOSUIT_HELMETS_BASIC", Assets.GetSprite("icon_inventory_atmosuit_helmet"), 100, new string[25]
		{
		...
		AddSubcategory("ATMOSUIT_GLOVES_BASIC", Assets.GetSprite("icon_inventory_atmosuit_gloves"), 500, new string[24]
		{
		...
		AddSubcategory("ATMOSUIT_BELTS_BASIC", Assets.GetSprite("icon_inventory_atmosuit_belt"), 700, new string[24]
		{
		...
		AddSubcategory("ATMOSUIT_SHOES_BASIC", Assets.GetSprite("icon_inventory_atmosuit_boots"), 900, new string[19]
		{
