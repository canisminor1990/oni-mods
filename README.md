...
| <img src="https://github.com/canisminor1990/oni-mods/blob/master/src/MoreRoomTypes/packaging/preview.png?raw=true" width="96" alt="More Room Types"> | [MoreRoomTypes](src/MoreRoomTypes) | More Room Types / 更多房间 | Adds extra colony room types. This standalone mod is built with thanks on pether.pg's [Rooms Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=2348079481); you do not need to subscribe to the original. |  |
| <img src="https://github.com/canisminor1990/oni-mods/blob/master/src/OnDemandProduction/packaging/preview.png?raw=true" width="96" alt="On-Demand Production"> | [OnDemandProduction](src/OnDemandProduction) | On-Demand Production / 按需生产 | Adds a third production mode to every production building. Click the Forever button to cycle Once, Maintain, and Forever. Maintain keeps a product in stock using this world's Resources list. | [Workshop](https://steamcommunity.com/sharedfiles/filedetails/?id=3797420331) |
