...
|  | [MoreRoomTypes](src/MoreRoomTypes) | More Room Types / 更多房间 | Adds extra colony room types. This standalone mod is built with thanks on pether.pg's [Rooms Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=2348079481); you do not need to subscribe to the original. |  |
